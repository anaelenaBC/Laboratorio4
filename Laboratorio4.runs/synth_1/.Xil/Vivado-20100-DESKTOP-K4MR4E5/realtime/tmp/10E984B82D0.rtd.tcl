...
set genomeRtd $env(RT_TMP)/10E984B82D0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {case__21_moduloReceptorUART__GD}]"
...
set genomeName [subst -nocommands -novariables {case__21_moduloReceptorUART__GD}]
