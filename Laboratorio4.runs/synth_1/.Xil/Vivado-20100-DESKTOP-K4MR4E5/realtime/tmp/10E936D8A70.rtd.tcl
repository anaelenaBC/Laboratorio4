...
set genomeRtd $env(RT_TMP)/10E936D8A70.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {moduloTransmisorUART}]"
...
set genomeName [subst -nocommands -novariables {moduloTransmisorUART}]
