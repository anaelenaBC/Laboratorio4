...
HD_PWD='C:/Users/aebol/OneDrive/Desktop/Laboratorio4/Laboratorio4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log moduloReceptorUART.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source moduloReceptorUART.tcl
